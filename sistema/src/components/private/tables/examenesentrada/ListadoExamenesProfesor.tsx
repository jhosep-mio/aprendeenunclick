...
import { type examenes } from '../../../shared/Interfaces'

export const ListadoExamenesProfesor = (): JSX.Element => {
  ...
  const getAllProductos = async (): Promise<void> => {
    ...
    const request = await axios.get(`${Global.url}/getExamenesProfesor/${auth.id}`, {
      headers: {
