...
import { type examenValues, type categoriasValues, type claseValues } from '../../../shared/Interfaces'
...
export const EditarExamenEntrada = (): JSX.Element => {
  ...
  const getExamen = async (): Promise<void> => {
    ...
    setValues({
      ...
      id_profesor: request.data.id_curso
    })
      ...
      {loading
        ...
        >
          ...
          <div className="w-full md:w-1/3 mb-6">
            ...
            <Errors errors={errors.id_profesor} touched={touched.id_profesor} />
          </div>
          {values.id_profesor && (
            <>
                                            ...
                                            ? <div className="flex gap-0 items-center justify-center h-full">
                                              ...
                                              >
                                                <img
                                                  // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                                                  // @ts-expect-error
                                                  src={ respuesta.imagen.preview.startsWith(
                                                    'data:'
                                                  )
                                                    ? respuesta.imagen.preview
                                                    // eslint-disable-next-line @typescript-eslint/no-base-to-string, @typescript-eslint/restrict-template-expressions
