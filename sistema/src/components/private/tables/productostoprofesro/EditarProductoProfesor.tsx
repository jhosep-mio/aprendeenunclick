...
// import { EditarItem } from '../productos/modals/EditarItem'
// import { AgregarNewItems } from '../productos/modals/AgregarNewItems'
// export const EditarProductoProfesor = (): JSX.Element => {
//   const { id } = useParams()
...
//     const request = await axios.get(`${Global.url}/getExamenes2`, {
//       headers: {
...
//     }
//     if (auth.id) {
//       if (request.data[0].id_profesor != auth.id) {
//         navigate('/admin/cursos/')
//       }
//     }
