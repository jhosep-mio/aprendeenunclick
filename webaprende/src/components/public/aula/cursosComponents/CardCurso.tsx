    ...
    <>
      {(() => {
        ...
        if (examenesCurso[idreal]) {
          ...
          const todasLasClasesEnProgreso = todasLasClasesCurso.every(
            (clase: any) => clasesConProgreso.includes(clase)
          )
              ...
              <div className="bg-[#6363a24d] px-10 py-8 rounded-xl flex justify-between items-center gap-2">
                <div className="flex gap-6">
                  ...
                  <div className="flex flex-col justify-center">
                    ...
                    <p className="text-[#cccccc] text-xl">Aprobado</p>
                  </div>
                </div>
                <div className="flex items-center gap-12">
                  <Link
                    to={`curso/${curso.id}-${formatearURL(curso.nombre)}`}
                    className="block px-8 py-4 bg-[#8282ff] hover:text-2xl text-white rounded-md"
                  >
                    Ver curso
                  </Link>
                </div>
              ...
              <div className="flex gap-6">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <p className="text-[#cccccc] text-xl">
                    {validacion ? 'En progreso' : 'Sin inicar'}
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-12">
