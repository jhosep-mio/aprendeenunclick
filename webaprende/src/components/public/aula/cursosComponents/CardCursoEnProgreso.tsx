...
const CardCursoEnProgreso = ({ curso, examenes, examenesCurso }: { curso: productosValues, examenes: valuesExamenesEntrada[], examenesCurso: valuesExamenesEntrada[] }): JSX.Element => {
  ...
  return (
    ...
    {(() => {
      ...
      if (examenesCurso[idreal]) {
        ...
        if (!todasLasClasesEnProgreso && validacion) {
          return (
...
export default CardCursoEnProgreso
