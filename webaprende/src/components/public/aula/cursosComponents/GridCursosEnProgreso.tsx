...
import CardCursoEnProgreso from './CardCursoEnProgreso'

const GridCursosEnProgreso = ({ cursos, examenes, examenesCurso }: { cursos: productosValues[], examenes: valuesExamenesEntrada[], examenesCurso: valuesExamenesEntrada[] }): JSX.Element => {
  return (
    <>
        ...
        <div className="profileCursos__main">
          {cursos.length > 0
            ...
            <div className="profileCursos__main__item" key={curso.id}>
              <CardCursoEnProgreso curso={curso} examenes={examenes} examenesCurso={examenesCurso}/>
            </div>
            ))
...
export default GridCursosEnProgreso
